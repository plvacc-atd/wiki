...
> **Kraków Ground, SP-ABC, ready for pushback and startup.**
...
> **SP-ABC, Kraków Ground, QNH ...., push(back) and start(up) approved (facing east).**
> **SP-ABC, Kraków Ground, QNH ...., możecie wypychać i uruchamiać (dziobem na wschód).**

:::info
Warto zauważyć, że prawidłowa frazeologia to "p&s approved / możecie wypychać i uruchamiać". Ze względu na specyfikę odpowiedzialności za poszczególne obszary lotniska kontroler GND **nie wydaje zezwolenia** na uruchamianie / wypychanie i uruchamianie, jedynie informuje, że załoga może tę czynność wykonywać.
:::
...
Dopiero po przejechaniu kołującego samolotu można poinformować załogę, że może rozpocząć wypychanie.
...
> **Kraków Ground, SP-ABC, gotowi do uruchamiania.**

> **SP-ABC, Kraków Ground, QNH ...., startup approved.**
> **SP-ABC, Kraków Ground, QNH ...., możecie uruchamiać.**
