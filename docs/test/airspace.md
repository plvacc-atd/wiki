...
W ramach ćwiczenia przyjrzyj się przestrzeni wokół lotniska Olsztyn-Szymany (EPSY). Wybraliśmy ten przykład, ponieważ jest to stosunkowo nieskomplikowana przestrzeń w porównaniu do tych otaczających większe polskie lotniska (np. EPWA czy EPKK).

![EPSY: ćwiczenie](assets/airspace-epsy.png)

*Źródło: AIP IFR, ENR 6.2-19 14.5.2026*

Najpierw spróbuj odczytać z zacytowanego fragmentu mapy, z jaką przestrzenią (w zależności od wysokości) mamy do czynienia w miejscach oznaczonych cyframi. Kiedy już się z tym uporasz, zajrzyj do rozwiązania poniżej.

<details>
    <summary>Rozwiązanie ćwiczenia</summary>
        <p>
        1. Już z mapy możemy wyczytać, że od wysokości 6500 stóp do FL95 sięga TMA Olsztyn (przestrzeń klasy D). Od FL95 do FL115 także mamy TMA Olsztyn, ale to już przestrzeń klasy C. Od FL115 do FL660 mamy przestrzeń kontrolowaną klasy C. Poniżej 6500 stóp znajduje się przestrzeń niekontrolowana klasy G.
        2. Ten punkt znajduje się w granicach poziomych CTR Olsztyn-Mazury, którego pionowe granice sięgają od powierzchni ziemi do 1500 stóp. Od 1500 stóp do FL95 mamy przestrzń TMA Olsztyn klasy D (zwróć uwage, że granice pionowe jej kolejnych elementow to 1500 stóp-3500 stóp i 3500 stóp do FL95). Od FL95 do FL115 jest TMA Olsztyn (klasa C), a od FL115 do FL660 mamy przestrzeń kontrolowaną klasy C znajdującą się ponad TMA. 
