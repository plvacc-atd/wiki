...
Przekazanie statku powietrznego do kontrolera TWR następuje zgodnie z zasadami podanymi w [GND 0 - Przekazanie statku powietrznego do kolejnego kontrolera](/docs/s1/ground/zdupylink.md).
