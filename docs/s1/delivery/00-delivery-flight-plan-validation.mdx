...
:::danger
ToDo
DODAĆ ODWOŁANIE DO SVFR oraz VMC
:::
...
## Poziom przelotu
Należy sprawdzić czy poziom przelotu został prawidłowo dobrany(patrz [Poziomy lotu](docs/basic/air-traffic-management/06-air-traffic-management-flight-levels.md)).
