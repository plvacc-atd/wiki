...
Jedną z funkcji planu lotu jest ułatwienie sprawdzenia, czy lot odbył się bezpiecznie. Upraszczając: kiedy lot się rozpoczyna, plan lotu jest otwierany, a gdy lot się kończy, plan lotu powinien zostać zamknięty. Otwarty i niezamknięty plan lotu może oznaczać, że "po drodze" coś poszło bardzo nie tak. Jeśli informacja o zakończeniu planu lotu lub lądowaniu nie zostanie zgłoszona w ciągu 30 minut od przewidywanego zakończenia planu lotu, uruchamiana jest służba alarmowa. Otwarcie i zamknięcie planu w przypadku, gdy lot odpowiednio zaczyna się lub kończy na lotnisku kontrolowanym, nie wymaga osobnego meldunku załogi o rozpoczęciu lub zakończeniu lotu. Jednak co jeśli lot rozpoczyna się lub kończy na lotnisku niekontrolowanym? Wówczas, po odlocie załoga powinna poprosić o otwarcie planu lotu, podając czas startu. Przeważnie następuje to po nawiązaniu łączności z FIS. Z kolei po lądowaniu na lotnisku niekontrolowanym także należy poinformować o jego zakończeniu (telefonicznie lub w aplikacji online). 
...
:::info
W realiach VATSIM stosujemy dużo prostsze reguły. Podstawowa brzmi banalnie: trzeba zaplanować lot, który ma odbyć się w przyszłości. W praktyce oznacza to, że załoga powinna zgłosić w planie lotu EOBT, który jeszcze nie minął. Bardziej szczegółowo: na lotniskach kontrolowanych w Polish VACC załogi powinny skontaktować się z kontrolerem Delivery (lub innym zapewniającym tę pozycję *top-down*) na co najmniej 30 minut przed EOBT, a zatem już wówczas plan lotu powinien być wysłany. W praktyce ta reguła jest jednak ściślej przestrzegana głównie w przypadku wzmożonego ruchu, a zwłaszcza podczas eventów. Ma wtedy istotne znaczenie dla zapewnienia płynności ruchu i uczciwej kolejki odlotów.
:::
