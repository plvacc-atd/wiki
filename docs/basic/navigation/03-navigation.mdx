...
**Course** określa zamierzoną linię drogi pomiędzy dwoma punktami lub kierunek odniesienia wykorzystywany podczas wykonywania procedur nawigacyjnych.

Nie należy utożsamiać go z headingiem – statek powietrzny może utrzymywać heading różniący się od course, aby skompensować wpływ wiatru.
