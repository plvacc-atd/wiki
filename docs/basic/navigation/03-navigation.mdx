...
**Kierunek geograficzny (True, T)** jest określany względem **północy geograficznej (True North)**, czyli kierunku wskazującego **geograficzny biegun północny** – punkt, w którym oś obrotu Ziemi przecina jej powierzchnię.
...
Ponieważ kompasy pokładowe opierają się na polu magnetycznym, kierunki magnetyczne są wykorzystywane podczas codziennej eksploatacji statków powietrznych. W większości państw świata również drogi startowe, procedury instrumentalne oraz instrukcje wydawane przez kontrolerów ruchu lotniczego odnoszą się właśnie do kierunków magnetycznych.

Przykładowo, polecenie:

> **ATC:** LOT123, turn right heading 270.
...
**Heading** określa kierunek, w którym skierowana jest podłużna oś statku powietrznego.

W polskiej terminologii lotniczej często określany jest jako **kurs statku powietrznego**, jednak w języku angielskim należy odróżnić heading od course.
...
Pilot wykonuje zakręt i stabilizuje lot z nosem skierowanym na kurs **270°**. Jeżeli występuje wiatr boczny, rzeczywista **linia drogi** statku powietrznego będzie różnić się od wydanego headingu.
...
Przykładowo, jeżeli pilot utrzymuje heading **090°**, a wiatr znosi statek powietrzny na południe, rzeczywisty track może wynosić **095°**.
...
**Course (CRS)** określa zamierzony kierunek linii drogi pomiędzy dwoma punktami lub kierunek odniesienia wykorzystywany podczas wykonywania procedur nawigacyjnych.

W przeciwieństwie do **headingu**, który opisuje kierunek, w którym skierowana jest podłużna oś statku powietrznego, **course** odnosi się do zamierzonej trajektorii lotu. W przypadku występowania wiatru statek powietrzny może utrzymywać heading różniący się od course, aby skompensować znoszenie i pozostać na wymaganej linii drogi.

Przykładowo:

- oś lokalizera **ILS** posiada określony **course** podejścia końcowego,
- odcinek pomiędzy dwoma punktami trasy **RNAV** posiada przypisany **course**,
- opublikowane procedury instrumentalne oraz odcinki tras mogą posiadać określone wartości **course**.

Przykład:

Podczas lotu po odcinku RNAV statek powietrzny ma utrzymać **course 090°**. W przypadku występowania wiatru bocznego pilot może ustawić **heading** różniący się od wartości **course**, aby skompensować znoszenie. Dzięki temu rzeczywisty **track** statku powietrznego pozostanie zgodny z wymaganą linią drogi.
...
- natomiast **linia drogi** (track) pozostanie zgodna z zaplanowaną trasą.

Przykładowo, jeżeli wiatr znosi statek powietrzny na południe, pilot może utrzymywać heading **085°**, aby rzeczywista linia drogi wynosiła **090°**.
