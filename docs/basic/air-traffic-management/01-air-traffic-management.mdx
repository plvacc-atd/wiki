...
(_Więcej informacji: [Służba alarmowa](/docs/basic/special_unsafe_situations/00-special-and-unsafe-situations.mdx#służba-alarmowa)_)
...
> **Zarządzanie przepływem ruchu lotniczego** (_Air traffic flow management, ATFM_): Służba ustanowiona w celu przyczyniania się do bezpiecznego, uporządkowanego i szybkiego przepływu ruchu lotniczego poprzez zapewnianie wykorzystania w maksymalnym stopniu pojemności ATC i aby wielkość tego ruchu była zgodna z pojemnością deklarowaną przez właściwy organ ATS.
