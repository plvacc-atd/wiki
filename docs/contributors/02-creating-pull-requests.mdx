...
# Dodawanie zmian do Wiki przez pull requesty
...
![główna gałąź](assets/02-main-branch.jpg)
...
![tworzenie gałęzi](assets/02-create-working-branch.jpg)
...
![dodaj pliki](assets/02-add-files.jpg)
...
![tworzenie folderu](assets/02-create-directory.png)
...
![commit](assets/02-commit-changes.jpg)
...
![tworzenie PR](assets/02-create-pull-request-1.jpg)
...
![manualne tworzenie pr](assets/02-manual-pull-request-creation.png)
...
![tworzenie PR 2](assets/02-create-pull-request-2.jpg)

Klik w `Create pull request` na dole strony ostatecznie kończy proces.

:::tip
Przydatne informacje:
- po stworzeniu Pull requesta nadal możesz dodawać zmiany na swojej gałęzi roboczej, pull request zawsze automatycznie zaktualizuje się po dodaniu (commitowaniu) przez Ciebie zmian
- warto spojrzeć na podsumowanie zmian wprowadzonych w plikach klikając na `Files changed`. Jest to świetne narzędzie do ostatecznego sprawdzenia proponowanej przez nas zmiany przed wkroczeniem recenzentów do akcji
  ![Lista zmian w plikach](assets/02-files-changed.png) 
...
Z Twojej strony to prawie wszystko. Poczekaj, aż jeden z recenzentów zapozna się z proponowanymi przez Ciebie zmianami i je zatwierdzi. Warto pamiętać, że recenzent tylko sprawdza Twoje treści i je aprobuje (lub ewentualnie wskazuje miejsca do poprawy). Ostateczne dodanie zmian do głównej gałęzi to zawsze obowiązek proponującego zmianę, czyli Ciebie. Zrobisz to klikając na dole strony pull requesta na `Squash and merge`

![merge](assets/02-squash-and-merge.png)


Pamiętaj, żeby posprzątać po sobie i [usunąć swoją roboczą gałąź](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-and-deleting-branches-within-your-repository#deleting-a-branch) po skończeniu pracy nad danym zagadnieniem.