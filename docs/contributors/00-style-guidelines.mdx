...
- jeśli załączamy obrazy, to powinny znajdować się w tym samym folderze co plik z artykułem. Nazwa pliku graficznego powinna zaczynać się od dwucyfrowej liczby odpowiadającej nazwie pliku tekstowego, w którym wystepuje. Nazwy powinna odzwierciedlać zawartość pliku, np.:
    - `docs/basic/meteorology/00-cold-front.jpg`
    - `docs/basic/meteorology/00-windshear.jpg`
    - `docs/s2/identification/03-radar-dome.png`
