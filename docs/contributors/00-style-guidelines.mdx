...
- jeśli załączamy obrazy, to powinny znajdować się w tym samym folderze co plik z artykułem. Nazwa pliku graficznego powinna zaczynać się od dwucyfrowej liczby odpowiadającej nazwie pliku tekstowego
